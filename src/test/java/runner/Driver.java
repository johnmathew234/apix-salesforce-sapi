...
public class Driver {
	...
	public void sendRequest(String reqestMethod) throws KeyManagementException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, FileNotFoundException {
				...
				RestAssured
				  ...
				  .sslConfig(
				    new SSLConfig().with().trustStoreType("JKS").and()
				      .trustStore(ResourceUtils.getFile("classpath:certs/apix-salesforce-sapi-cert.jks"), "njclabs"))
				);
		return request;
	}
